...
<body>
  ...
  <nav class="navbar navbar-default navbar-fixed-top" style="background-color:#191970;">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="dbwelcome.php" style="color:white;font-size:155%;"><span>AUTOMATIC ATTENDANCE SYSTEM</span></a>
        <br>
      </div>
        ...
        <li>
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="fac_login.php">Faculty</a>
            </div>
          </div>
        </li>
    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-left">
          <h2 style="color:#191970;">About</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-6 padleft-right text-justify">
            <p>Taking attendance for a large class consumes significant time. With the help of this website, group photos of the students will be uploaded and all students present will be marked as present. </p>
        </div>
      </div>
    </div>
  </section>
  ...
  <p><br></p>
    <div class="container text-center">
      ...
      <p style="color:#f5f5f5;">©All rights reserved</p>
